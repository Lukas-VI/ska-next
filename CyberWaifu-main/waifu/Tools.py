...
def load_prompt(filename: str):
    file_path = f'C:/Users/1/Documents/ROb/CyberWaifu-main/presets/charactor/{filename}.txt'
    try:
...
def load_emoticon(emoticons: list):
    ...
    for i in range(0, len(emoticons), 2):
        ...
        files.append(f'C:/Users/1/Documents/ROb/CyberWaifu-main/presets/emoticon/{emoticons[i][1]}')
    try:
        with open(f'C:/Users/1/Documents/ROb/CyberWaifu-main/presets/emoticon/emoticon.json', 'w',encoding='utf-8') as f:
...
def load_memory(filename: str, waifuname):
    ...
    try:
        with open(file_path, "r", encoding="utf-8") as f:
            memory = f.read()
        if os.path.exists(f'C:/Users/1/Documents/ROb/CyberWaifu-main/memory/{waifuname}.csv'):
