...
config_path = "C:/Users/1/Documents/ROb/CyberWaifu-main/config.ini" 
# 读取配置文件

config_files = config.read(config_path, encoding='utf-8')
...
if model == 'OpenAI':
    ...
    callback = WaifuCallback(send_text, send_voice)
	...
	brain = Claude(bot_id, user_oauth_token, name) # type: ignore
...
make_qq_bot(callback, waifu, send_text, send_voice, tts) # type: ignore