...
### 🎯 项目亮点
✅ **📦 核心框架**: 基于 nagaagent-core 核心功能包，**[nagaagent-core](https://pypi.org/project/nagaagent-core/)**  
...
| 类别 | 依赖包 | 用途 |
|------|--------|------|
| **核心框架** | `nagaagent-core`, `openai`, `mcp`, `fastapi` | 核心功能包、AI对话和API服务 |
...
| 模块 | 功能 | 技术栈 |
|------|------|--------|
| **核心框架** | 基础功能组件和工具 | nagaagent-core, Python |
...
#### 🚀 新增功能
- **📦 核心框架包**: 发布 nagaagent-core 核心功能包到 PyPI，提供流式工具调用、MCP管理、消息管理等基础组件
